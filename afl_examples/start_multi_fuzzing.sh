...
# start master anyway...
tmux new-session -d -s $module_name.01master "source ~/.bashrc; py-afl-fuzz -m 5000  -i ./inputs/$module_name/inputs -o outputs/$module_name -M fuzzer0 -- python3 ./wrapper-modules.py  @@ $module_name"
sleep 1
...
do
    ...
    tmux new-session -d -s $module_name.$i.slave "source ~/.bashrc; py-afl-fuzz -m 5000  -i ./inputs/$module_name/inputs -o outputs/$module_name -S fuzzer$i -- python3 ./wrapper-modules.py  @@ $module_name"
    sleep 1
done
